...
//            self.iconLabel.frame = CGRectMake(0, self.bounds.size.height - textHeight, iconWidth, textHeight)
            ...
            self.iconLabel.frame = CGRect(origin: CGPoint(x: 0,y : self.bounds.size.height - textHeight), size: CGSize(width: iconWidth, height: textHeight))
...
//            self.iconLabel.frame = CGRectMake(textWidth - iconWidth, self.bounds.size.height - textHeight, iconWidth, textHeight)
            ...
            self.iconLabel.frame = CGRect(origin: CGPoint(x: textWidth - iconWidth,y : self.bounds.size.height - textHeight), size: CGSize(width: iconWidth, height: textHeight))
